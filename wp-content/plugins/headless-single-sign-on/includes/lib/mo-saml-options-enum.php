<?php
include "MoHssoSAMLBasicEnum.php";

class mo_hsso_options_enum_sso_loginMoSAML extends MoHssoSAMLBasicEnum {
	const Force_authentication = 'mo_saml_force_authentication';
}

class mo_hsso_options_enum_identity_providerMoSAML extends MoHssoSAMLBasicEnum{
	const SP_Base_Url='mo_saml_sp_base_url';
	const SP_Entity_ID = 'mo_saml_sp_entity_id';
}

class mo_hsso_options_enum_service_providerMoSAML extends MoHssoSAMLBasicEnum{
...
class mo_hsso_options_test_configuration extends MoHssoSAMLBasicEnum{
    const SAML_REQUEST = 'MO_SAML_REQUEST';
    const SAML_RESPONSE = 'MO_SAML_RESPONSE';
    const TEST_CONFIG_ERROR_LOG = 'MO_SAML_TEST';
}

class mo_hsso_options_enum_attribute_mappingMoSAML extends MoHssoSAMLBasicEnum{
...
class mo_hsso_options_enum_role_mappingMoSAML extends MoHssoSAMLBasicEnum{
...
class mo_hsso_options_error_constants extends MoHssoSAMLBasicEnum{
...
class mo_hsso_options_plugin_constants extends  MoHssoSAMLBasicEnum{
     const CMS_Name = "WP";
     const Application_Name = "Headless Single Sign On";
     const Application_type = "SAML";
     const Version = "1.4.1";
     const HOSTNAME = "https://login.xecurify.com";
     const WP_Version = "5.9";
     const PLUGIN_FILE = "headless-single-sign-on/login.php";
}

class mo_hsso_options_plugin_idp_specific_ads extends MoHssoSAMLBasicEnum{
...
class mo_hsso_options_suggested_add_ons extends  MoHssoSAMLBasicEnum {
...
class mo_hsso_options_plugin_idp extends  MoHssoSAMLBasicEnum{
...
class mo_hsso_options_plugin_idp_videos extends  MoHssoSAMLBasicEnum{
...
class mo_hsso_options_addons extends MoHssoSAMLBasicEnum{
...
class mo_hsso_license_plans extends MoHssoSAMLBasicEnum {
...
class mo_hsso_time_zones extends  MoHssoSAMLBasicEnum {
