...
class HssoSAML2Response
{
    ...
    public function __construct(DOMElement $xml = NULL)
    {
		...
		for ($node = $xml->firstChild; $node !== NULL; $node = $node->nextSibling) {
			...
			if ($node->localName === 'Assertion' || $node->localName === 'EncryptedAssertion') {
				$this->assertions[] = new HssoSAML2Assertion($node);
			}
     ...
     *
     * @return HssoSAML2Assertion[]|SAML2_EncryptedAssertion[]
     */
     ...
     *
     * @param HssoSAML2Assertion[]|SAML2_EncryptedAssertion[] The assertions.
     */
