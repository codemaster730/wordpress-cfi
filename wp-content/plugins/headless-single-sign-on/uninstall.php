...
delete_option('mo_hsso_endpoint');
delete_option('mo_hsso_url');
delete_option('mo_hsso_enable_headless');
delete_option('mo_hsso_wp_setting');


if(!(get_option('mo_hsso_keep_settings_on_deletion')==='true')) {
    if (!is_multisite()) {
