<?php
/**
 * Grimlock_Animate_Author_Avatars_Section_Component Class
 *
 * @author   Themosaurus
 * @since    1.0.0
 * @package  grimlock
 ...
 */
class Grimlock_Animate_Author_Avatars_Section_Component extends Grimlock_Author_Avatars_Section_Component {
	/**
	 * Setup class.
	 *
	 * @param array $props
	...
	public function __construct( $props = array() ) {
		parent::__construct( wp_parse_args( $props, array(
			'members_reveal_selector'    => '.section__header, .grimlock-author-avatars__user, .section__footer',
			'members_reveal'             => 'none',
			'members_reveal_duration'    => 750,
			'members_reveal_interval'    => 50,
			'members_reveal_distance'    => '80px',
			'members_reveal_delay'       => 500,
			'members_reveal_rotate_x'    => 0,
			'members_reveal_rotate_y'    => 0,
			'members_reveal_rotate_z'    => 0,
			'members_reveal_opacity'     => 0,
			'members_reveal_scale'       => 1,
			'members_reveal_easing'      => 'cubic-bezier(0.6, 0.2, 0.1, 1)',
			'members_reveal_view_factor' => 0.5,
			'reveal_mobile'              => true,
			'reveal_reset'               => false,
		) ) );
	}
	...
	public function get_data_attributes() {
		...
		return array_merge( $data_attributes, $this->get_element_reveal_data_attributes( 'members' ) );
	}
	...
	public function get_class( $class = '' ) {
		...
		$classes[] = $this->get_element_reveal_class( 'members' );
