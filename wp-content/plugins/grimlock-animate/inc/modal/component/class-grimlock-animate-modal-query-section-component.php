...
/**
 * Class Grimlock_Animate_Modal_Query_Section_Component
 *
 * @author  themosaurus
 * @since   1.0.0
 * @package grimlock-animate
 */
class Grimlock_Animate_Modal_Query_Section_Component extends Grimlock_Modal_Query_Section_Component {
	/**
	 * Setup class.
	 *
	 * @param array $props
