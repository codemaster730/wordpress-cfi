...
(function($, global) {
	...
	var EPKBDialogsManager = {
		...
		createWidgetType: function(typeName, properties, Parent) {
			...
			WidgetType.extend = function(typeName, properties) {
				...
				return EPKBDialogsManager.createWidgetType(typeName, properties, WidgetType);
			};
	 ...
	 */
	EPKBDialogsManager.Instance = function() {
		...
		this.createWidget = function(widgetType, properties) {
			...
			var WidgetTypeConstructor = EPKBDialogsManager.getWidgetType(widgetType),
	 ...
	 */
	EPKBDialogsManager.Widget = function(widgetName) {
		...
		this.init = function(parent, properties) {
			...
			if (!(parent instanceof EPKBDialogsManager.Instance)) {
				throw 'The ' + self.widgetName + ' must to be initialized from an instance of EPKBDialogsManager.Instance';
			}
	...
	EPKBDialogsManager.Widget.prototype.types = [];

	// Inheritable widget methods
	EPKBDialogsManager.Widget.prototype.buildWidget = function() {
	...
	EPKBDialogsManager.Widget.prototype.attachEvents = function() {
	...
	EPKBDialogsManager.Widget.prototype.getDefaultSettings = function() {

		return {};
	};

	EPKBDialogsManager.Widget.prototype.getClosureMethods = function() {

		return [];
	};

	EPKBDialogsManager.Widget.prototype.onHide = function() {
	};

	EPKBDialogsManager.Widget.prototype.onShow = function() {
	};

	EPKBDialogsManager.Widget.prototype.onInit = function() {
	};

	EPKBDialogsManager.Widget.prototype.onReady = function() {
	};

	EPKBDialogsManager.widgetsTypes.simple = EPKBDialogsManager.Widget;

	EPKBDialogsManager.addWidgetType('buttons', {
		...
		buildWidget: function() {
			...
			EPKBDialogsManager.Widget.prototype.buildWidget.apply(this, arguments);
	...
	EPKBDialogsManager.addWidgetType('lightbox', EPKBDialogsManager.getWidgetType('buttons').extend('lightbox', {
		getDefaultSettings: function() {

			var settings = EPKBDialogsManager.getWidgetType('buttons').prototype.getDefaultSettings.apply(this, arguments);
		...
		buildWidget: function() {
			...
			EPKBDialogsManager.getWidgetType('buttons').prototype.buildWidget.apply(this, arguments);
	...
	EPKBDialogsManager.addWidgetType('confirm', EPKBDialogsManager.getWidgetType('lightbox').extend('confirm', {
		onReady: function() {
		...
		getDefaultSettings: function() {
			...
			var settings = EPKBDialogsManager.getWidgetType('lightbox').prototype.getDefaultSettings.apply(this, arguments);
	...
	EPKBDialogsManager.addWidgetType('alert', EPKBDialogsManager.getWidgetType('lightbox').extend('alert', {
		onReady: function() {
	...
	// Exporting the EPKBDialogsManager variable to global
	global.EPKBDialogsManager = EPKBDialogsManager;
})(
