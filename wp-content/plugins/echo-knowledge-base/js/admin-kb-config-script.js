jQuery(document).ready(function($) {
	...
	function epkb_select_categories_custom_ordering() {
		...
		if ( $('#epkb-main-page').closest('.epkb-info-pages').hasClass('epkb-active-page') ) {
			$('#epkb-config-ordering-sidebar').find('input[name=categories_display_sequence][value=user-sequenced]').trigger('click');
		} else if ( $('#epkb-article-page').closest('.epkb-info-pages').hasClass('epkb-active-page') ) {
			$('#epkb-config-article-ordering-sidebar').find('input[name=categories_display_sequence][value=user-sequenced]').trigger('click');
		}
	}
	...
	function epkb_add_custom_ordering() {
		...
		$('.epkb-config-content .eckb-articles-ordering, .eckb-articles-ordering').sortable({
			...
			update: function (event, ui)
			{
				...
				if ( $('#epkb-main-page').closest('.epkb-info-pages').hasClass('epkb-active-page') ) {
					$('#epkb-config-ordering-sidebar').find('input[name=articles_display_sequence][value=user-sequenced]').trigger('click');
				} else if ( $('#epkb-article-page').closest('.epkb-info-pages').hasClass('epkb-active-page') ) {
					$('#epkb-config-article-ordering-sidebar').find('input[name=articles_display_sequence][value=user-sequenced]').trigger('click');
				}
			}
		});
	}
	...
	$('#epkb-main-page-content').on('main_content_changed', function() {
	...
	$('#epkb-article-page-content').on('article_content_changed', function() {
	...
	function epkb_disable_clicks() {
		...
		$('.epkb-navigation-button').attr('onclick','').off('click');
	}
...

	{
		...
		$( '#epkb-config-main-info-todo').find('.page-icon' ).on( 'click', function() {  // TODO we don't need this any more
...
*/
		...
		var epkb_mega_menu = {
			...
			general:    function() {
				...
				$( '#epkb-config-main-info-todo .epkb-setting-icon' ).on( 'click', function(){ // TODO
				...
				$( '#epkb-admin-mega-menu' ).on( 'click', '#template_group', function() {
		...
		$( '#template_group' ).find( ":radio" ).on('click', function(){
...
*/
...

	{
		...
		$('#epkb-config-main-info-todo').on('change', '#epkb-layout-preview-data', function (e) { // TODO
...
*/
...

	{
		...
		$( '#epkb-config-main-info-todo').on( 'click', '.epkb-info-pages', function(){ // TODO
			epkb_set_tabs_height();
		} );
	...
	$('#epkb-config-open-old, #show-old-config').on('click',function(){
		$('.epkb-info-old').show();
