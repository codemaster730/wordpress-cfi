				...
				<div class="epkb-wizard-header">
					<div class="epkb-wizard-header__info">
						<h1 class="epkb-wizard-header__info__title">
							<?php _e( 'Search Settings', 'echo-knowledge-base'); ?>
						</h1>
	...
	private function wizard_step_finish() {    
		...
		<div id="epkb-wsb-step-<?php echo $i+1; ?>-panel" class="epkb-wc-step-panel eckb-wizard-step-5" style="display: none">
			<div class="epkb-wizard-row-1">
				<p><?php _e( 'Change your Search Text:', 'echo-knowledge-base' ); ?></p>
				<a href="<?php echo esc_url( admin_url('edit.php?post_type=' . EPKB_KB_Handler::get_post_type( $this->kb_id )) . '&page=epkb-kb-configuration&wizard-text' ); ?>" target="_blank" class="epkb-wizard-button">
					<span class="epkb-wizard-btn-text"><?php _e( 'Click Here', 'echo-knowledge-base' ); ?></span>
					<span class="epkb-wizard-btn-icon ep_font_icon_external_link"></span>
				</a>
			</div>
			<div class="epkb-wizard-row-1">
				<p><?php _e( 'Change your Search Colors:', 'echo-knowledge-base' ); ?></p>
				<a href="<?php echo esc_url( admin_url('edit.php?post_type=' . EPKB_KB_Handler::get_post_type( $this->kb_id )) . '&page=epkb-kb-configuration&wizard-on' ); ?>" target="_blank" class="epkb-wizard-button">
					<span class="epkb-wizard-btn-text"><?php _e( 'Click Here', 'echo-knowledge-base' ); ?></span>
					<span class="epkb-wizard-btn-icon ep_font_icon_external_link"></span>
				</a>
			</div>
