...
class EPKB_KB_Wizard_Text {
				...
				<div class="epkb-wizard-header">
					<div class="epkb-wizard-header__info">
						<h1 class="epkb-wizard-header__info__title">
							<?php _e( 'Text Settings', 'echo-knowledge-base'); ?>
						</h1>
	...
	public function archive_page_text_inputs( $args ) {
		...
		$form->option_group_wizard( $feature_specs, array(
			...
			'class'             => 'eckb-wizard-texts eckb-wizard-accordion__body',
			'inputs'            => array (
				'0' => $form->text( $feature_specs['template_category_archive_page_heading_description'] + array(
						'value'             => $kb_config['template_category_archive_page_heading_description'],
						'input_group_class' => 'eckb-wizard-single-text',
					) ),
				'1' => $form->text( $feature_specs['template_category_archive_read_more'] + array(
						'value'             => $kb_config['template_category_archive_read_more'],
						'input_group_class' => 'eckb-wizard-single-text',
					) ),
			)
		));
