...
class EPKB_KB_Wizard_Features {
	...
	private function main_page_features() {         ?>
		...
		<div id="epkb-wsb-step-1-panel" class="epkb-wc-step-panel eckb-wizard-step-1 epkb-wc-step-panel--active">
			<div class="epkb-wizard-features-main-page-preview eckb-wizard-help">
				<div class="eckb-wizard-help__image"></div>
			</div>
	...
	public function main_page_feature_inputs( $args ) {
		...
		$form->option_group_wizard( $feature_specs, array(
			...
			'inputs'            => array (
				'0' => $form->checkbox( $feature_specs['template_main_page_display_title'] + array(
						'value'             => $kb_config['template_main_page_display_title'],
		...
		$form->option_group_wizard( $feature_specs, array(
			...
			'inputs' => array(
				...
				'2' => $form->text_and_select_fields_horizontal( array(
					...
					'main_label_class'  => 'config-col-5',
					'label'             => __( 'List Height of Articles', 'echo-knowledge-base' ),
					'input_class'       => 'config-col-6',
				), $arg1, $arg2 )
			)
		));
	...
	public function article_page_feature_inputs( $args ) {
		...
		$form->option_group_wizard( $feature_specs, array(
			...
			'inputs'            => array(
				'0' => $form->checkbox( $feature_specs['breadcrumb_enable'] + array(
						'value'             =>$kb_config['breadcrumb_enable'],
						'input_group_class' => 'eckb-wizard-single-checkbox',
						'label_class'       => 'config-col-5',
						'input_class'       => 'config-col-2',
						'data' => array(
		...
		$arg1_toc_level =  $feature_specs['article_toc_hx_level'] + array(
				'value' => $kb_config['article_toc_hx_level'],
				'current' => $kb_config['article_toc_hx_level'],
		...
		$arg2_toc_level =  $feature_specs['article_toc_hy_level'] + array(
				'value' => $kb_config['article_toc_hy_level'],
				'current' => $kb_config['article_toc_hy_level'],
				'label_class'       => 'config-col-6',
				'input_class'       => 'config-col-6',
				'data' => array(
					'preview' => 1
		...
		$form->option_group_wizard( $feature_specs, array(
			...
			'inputs'            => array(
				'0' => $form->checkbox( $feature_specs['article_content_enable_back_navigation'] + array(
						'value'             =>$kb_config['article_content_enable_back_navigation'],
						'input_group_class' => 'eckb-wizard-single-checkbox',
						'label_class'       => 'config-col-5',
						'input_class'       => 'config-col-2',
						'data' => array(
	...
	public function article_sidebars_feature_inputs( $args ) {
		...
		$left_sidebar_inputs = array(
				...
				'1' => $form->checkbox( $feature_specs['article-left-sidebar-toggle'] + array(
						'value'             =>$kb_config['article-left-sidebar-toggle'],
						'current'           =>$kb_config['article-left-sidebar-toggle'],
						'input_group_class' => 'eckb-wizard-single-checkbox',
						'label_class'       => 'config-col-3',
						'input_class'       => 'config-col-9',
						'data' => array(
				...
				'2' => $form->checkbox( $feature_specs['article-left-sidebar-match'] + array(
				...
				'3' => $form->text( $feature_specs['article-left-sidebar-starting-position'] +
		...
		$form->option_group_wizard( $feature_specs, array(
			...
			'inputs'            => array(
				...
				'1' => $form->checkbox( $feature_specs['article-right-sidebar-toggle'] + array(
						'value'             =>$kb_config['article-right-sidebar-toggle'],
						'current'           =>$kb_config['article-right-sidebar-toggle'],
						'input_group_class' => 'eckb-wizard-single-checkbox',
						'label_class'       => 'config-col-3',
						'input_class'       => 'config-col-9',
						'data' => array(
				...
				'2' => $form->checkbox( $feature_specs['article-right-sidebar-match'] + array(
				...
				'3' => $form->text( $feature_specs['article-right-sidebar-starting-position'] +
				...
				'6' => $form->text( array($kb_config['article-right-sidebar-desktop-width-v2'],
				...
				'7' => $desktop_columns_alert,
				'8' => $form->text( array($kb_config['article-right-sidebar-tablet-width-v2'],
				...
				'9' => $tablet_columns_alert,
			)
		));
		
		// BREAKPOINTS
		$form->option_group_wizard( $feature_specs, array(
			'option-heading'    => __( 'Screen Breakpoints', 'echo-knowledge-base' ),
			'class'             => 'eckb-wizard-features eckb-wizard-accordion__body',
			'depends'        => array(
				'show_when' => array(
					'article-structure-version' => 'version-2',
	...
	public function archive_page_feature_inputs( $args ) {
		...
		$form->option_group_wizard( $feature_specs, array(
			...
			'class'             => 'eckb-wizard-features eckb-wizard-accordion__body',
			'inputs'            => array(
				'0' => $form->radio_buttons_vertical( $feature_specs['template_category_archive_page_style'] + array(
						'value'             =>$kb_config['template_category_archive_page_style'],
						'current'           =>$kb_config['template_category_archive_page_style'],
						'input_group_class' => 'eckb-wizard-radio-btn-vertical',
						'main_label_class'  => 'config-col-4',
						'input_class'       => 'config-col-8',
						'radio_class'       => 'config-col-12',
