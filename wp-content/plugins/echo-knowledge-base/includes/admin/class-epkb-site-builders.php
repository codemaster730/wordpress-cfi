...
class EPKB_Site_Builders {
	...
	private function show_builder_notice( $builder_name, $builder_admin_url, $place, $option_name ) {
		...
		// message
		$reason     = __( 'Ensure that the Knowledge Base option is checked.', 'echo-knowledge-base' );
	...
	private function check_vc_cpt() {
		...
		if ( EPKB_Core_Utilities::is_kb_flag( 'vc_notice_shown' ) ) {
			return true;
		}

		EPKB_Core_Utilities::update_kb_flag( 'vc_notice_shown' );
	...
	private function check_beaver_cpt() {
		...
		// show one time notice
		if ( EPKB_Core_Utilities::is_kb_flag( 'beaver_notice_shown' ) ) {
			return true;
		}

		EPKB_Core_Utilities::update_kb_flag( 'beaver_notice_shown' );
	...
	private function check_so_cpt() {
		...
		// show one time notice
		if ( EPKB_Core_Utilities::is_kb_flag( 'so_notice_shown' ) ) {
			return true;
		}

		EPKB_Core_Utilities::update_kb_flag( 'so_notice_shown' );
