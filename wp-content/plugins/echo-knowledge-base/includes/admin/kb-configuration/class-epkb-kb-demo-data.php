...
class EPKB_KB_Demo_Data {
	...
	// DEPRECATED since 9.0.0 - still used by old Elegant Layouts
	public static function get_category_demo_data( $layout, $kb_config ) {
		...
		if ( EPKB_Icons::is_theme_with_image_icons( $kb_config ) || $image_found ) {

			$category_icons = array(
				11 => array(
					'type' => 'image',
					'image_id' => 0,
					'image_thumbnail_url' => Echo_Knowledge_Base::$plugin_url . 'img/demo-icons/icons/users.png',
					'name' => 'ep_font_icon_person',
				),     // Account
				22 => array(
					'type' => 'image',
					'image_id' => 0,
					'image_thumbnail_url' => Echo_Knowledge_Base::$plugin_url . 'img/demo-icons/icons/download-icon.png',
					'name' => 'ep_font_icon_shopping_cart',
				),// Ordering
				33 => array(
					'type' => 'image',
					'image_id' => 0,
					'image_thumbnail_url' => Echo_Knowledge_Base::$plugin_url . 'img/demo-icons/icons/server-icon.png',
					'name' => 'ep_font_icon_credit_card',
				), // Payment
				44 => array(
					'type' => 'image',
					'image_id' => 0,
					'image_thumbnail_url' => Echo_Knowledge_Base::$plugin_url . 'img/demo-icons/icons/earth-icon.png',
					'name' => 'epkbfa-truck',
				),       // Shipping
				55 => array(
					'type' => 'image',
					'image_id' => 0,
					'image_thumbnail_url' => Echo_Knowledge_Base::$plugin_url . 'img/demo-icons/icons/mobile-icon.png',
					'name' => 'epkbfa-bookmark',
				),     // Returns & Refunds
				66 => array(
					'type' => 'image',
					'image_id' => 0,
					'image_thumbnail_url' => Echo_Knowledge_Base::$plugin_url . 'img/demo-icons/icons/sheild-icon.png',
