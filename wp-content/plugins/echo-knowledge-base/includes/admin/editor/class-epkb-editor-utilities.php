...
class EPKB_Editor_Utilities {
	 ...
	 * @return array
	 */
	public static function get_editor_urls( $kb_config, $main_page_zone_name='', $article_page_zone_name='', $archive_page_zone_name='', $use_backend_mode = true ) {

		if ( $use_backend_mode && EPKB_Core_Utilities::is_kb_flag( 'editor_backend_mode' ) ) {
			$url = admin_url( '/edit.php?post_type=' . EPKB_KB_Handler::get_post_type( EPKB_KB_Handler::get_current_kb_id() ) . '&page=epkb-kb-configuration#kb-design' );
