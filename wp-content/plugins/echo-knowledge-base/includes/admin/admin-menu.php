...
function epkb_add_plugin_menus() {
	...
	add_submenu_page( 'edit.php?post_type=' . $post_type_name, __( 'Get Started - Echo Knowledge Base', 'echo-knowledge-base' ), __( 'Get Started', 'echo-knowledge-base' ),
		EPKB_Admin_UI_Access::get_context_required_capability( ['admin_eckb_access_need_help_read'] ), 'epkb-kb-need-help', array(new EPKB_Need_Help_Page(), 'display_need_help_page') );
	...
	add_submenu_page( 'edit.php?post_type=' . $post_type_name, __( 'Configuration - Echo Knowledge Base', 'echo-knowledge-base' ), __( 'Configuration', 'echo-knowledge-base' ),
		EPKB_Admin_UI_Access::get_context_required_capability( ['admin_eckb_access_order_articles_write', 'admin_eckb_access_frontend_editor_write'] ), 'epkb-kb-configuration', array(new EPKB_Configuration_Page(), 'display_kb_config_page') );
