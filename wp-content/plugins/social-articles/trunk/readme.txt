...
= 2.9.5 =
* Bug Fixing
* Support for WP 5.0 and BP 3.2

= 2.9 =
* Compatibility for non string notifications
* Bug Fixing: Role Visibility it's working well now
* Support for WP 4.9.7 and BP 3.1.0


= 2.8 =
* New option to reset social articles options - Troubleshooting
* Bug Fixing: Image rotation fix when photos are uploaded with iphone
* Bug Fixing: Clean some debug errors and notices

= 2.7 =
* New option to show articles in not logged in users profile
* Bug Fixing: Check that notification module is active
* Bug Fixing: Clean some debug errors

= 2.6 =
* Advance tinyMCE options
* Bug Fixing: Notification hour was wrong
* Bug Fixing: Not send notification to author when is direct workflow
* Support for WP 4.9.4 and BP 2.9.3
...
* Bug fixing
* PHP 7 errors fixed
* Link in notification bar fixed
* Support for WP 4.8.2 and BP 2.9.1
...
* Improve usability
* Improve performance
* Support for WP 4.8 and BP 2.8.2
