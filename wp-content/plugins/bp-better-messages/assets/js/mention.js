!function (e, t) {
    ...
    return function (e) {
        ...
        var r = i(1), o = n(r), l = t.LEFT_ARROW_KEYCODE = 37, h = t.BMTCMention = o["default"].Extension.extend({
            ...
            extraPanelClassName: "bp-messages-wrap",
            ...
            initMentionPanel: function () {
                ...
                e.classList.add("bm-medium-editor-mention-panel"), e.classList.add("bp-better-messages-secondary"), (this.extraPanelClassName || this.extraClassName) && e.classList.add(this.extraPanelClassName || this.extraClassName), this.getEditorOption("elementsContainer").appendChild(e), this.mentionPanel = e
            },
