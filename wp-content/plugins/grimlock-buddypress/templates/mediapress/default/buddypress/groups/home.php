...
<div role="navigation" id="subnav" class="d-flex flex-column flex-lg-row mb-3 mb-md-4 mt-0 text-center">
	<div class="item-list-tabs primary-list-tabs no-ajax mpp-group-nav">
