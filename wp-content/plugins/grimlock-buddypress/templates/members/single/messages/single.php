		...
		<header class="message-header card card-static p-4 mb-4">
			...
			<div class="row align-items-center">
				...
				<div class="col-sm-3">
					...
					<a class="btn bg-black-faded btn-sm confirm float-sm-right mt-2 mt-sm-0" style="color: inherit;" href="<?php bp_the_thread_delete_link(); ?>" data-toggle="tooltip" data-placement="top" title="<?php esc_attr_e( 'Delete', 'buddypress' ); ?>"><i class="fa fa-trash fa-lg"></i></a>

					<?php if ( function_exists( 'bp_the_thread_exit_link' ) && bp_get_thread_recipients_count() > 2 ) : ?>
						<a class="btn bg-black-faded btn-sm confirm float-left float-sm-right mt-2 mt-sm-0 mr-2" style="color: inherit;" href="<?php bp_the_thread_exit_link(); ?>" data-toggle="tooltip" data-placement="top" title="<?php esc_attr_e( 'Exit Conversation', 'buddypress' ); ?>"><i class="fa fa-sign-out fa-lg"></i></a>
					<?php endif; ?>
