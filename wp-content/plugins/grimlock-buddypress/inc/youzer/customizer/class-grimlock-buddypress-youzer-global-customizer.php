<?php
/**
 * Grimlock_BuddyPress_Youzer_Global_Customizer Class
 *
 * @author   Themosaurus
 * @since    1.0.0
 * @package grimlock
 ...
 */
class Grimlock_BuddyPress_Youzer_Global_Customizer {
	/**
	 * Setup class.
	 *
	 * @since 1.0.0
...
return new Grimlock_BuddyPress_Youzer_Global_Customizer();
