...
<div class="card">
	...
	<div class="card-body">
		...
		<div class="row align-items-center">
			...
			<?php if ( has_post_thumbnail() ) : ?>
				<div class="col-md-5 col-lg-5">
					<div class="pos-r clearfix ov-h">
						<!-- Event Image -->
						<?php echo wp_kses_post( tribe_event_featured_image( null, 'thumbnail-4-4-4-cols-classic' ) ); ?>
						<!-- Event Cost -->
			...
			<div class="<?php if ( has_post_thumbnail() ) : ?>col-md-7 col-lg-7<?php else : ?>col-sm-12<?php endif; ?>">
