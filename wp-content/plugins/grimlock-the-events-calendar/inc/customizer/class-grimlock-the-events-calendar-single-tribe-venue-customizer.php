 ...
 */
class Grimlock_The_Events_Calendar_Single_Tribe_Venue_Customizer extends Grimlock_Singular_Template_Customizer {
	/**
	 * Setup class.
	 *
	 * @since 1.0.0
	...
	public function __construct() {
		$this->id      = 'single_tribe_venue';
		$this->section = 'grimlock_the_events_calendar_single_tribe_venue_customizer_section';
		$this->title   = esc_html__( 'Single Venue', 'grimlock-the-events-calendar' );
	...
	public function add_body_classes( $classes ) {
		...
		if ( $this->is_template() ) {
			$displayed_theme_mods = array(
				'single_tribe_venue_breadcrumb_custom_header_displayed',

				'single_tribe_venue_thumbnail_displayed',
				'single_tribe_venue_address_displayed',
				'single_tribe_venue_phone_displayed',
				'single_tribe_venue_website_displayed',
				'single_tribe_venue_breadcrumb_displayed',
			);
	...
	public function add_customizer_controls_js_data( $js_data ) {
		$js_data['tabs'][$this->section] = array(
			array(
				...
				'class' => 'single_tribe_venue-general-tab',
				'controls' => array(
					"{$this->section}_heading_10",
					'single_tribe_venue_custom_header_displayed',
					'single_tribe_venue_address_custom_header_displayed',
					'single_tribe_venue_phone_custom_header_displayed',
					'single_tribe_venue_website_custom_header_displayed',
					'single_tribe_venue_breadcrumb_custom_header_displayed',
			...
			array(
				...
				'class' => 'single_tribe_venue-layout-tab',
				'controls' => array(
					'single_tribe_venue_custom_header_layout',
					"{$this->section}_divider_110",
					'single_tribe_venue_custom_header_container_layout',
					"{$this->section}_divider_120",
					'single_tribe_venue_layout',
					'single_tribe_venue_sidebar_mobile_displayed',
					"{$this->section}_divider_140",
					'single_tribe_venue_container_layout',
				),
			),
			array(
				'label' => esc_html__( 'Style', 'grimlock-the-events-calendar' ),
				'class' => 'single_tribe_venue-style-tab',
				'controls' => array(
					'single_tribe_venue_custom_header_padding_y',
					"{$this->section}_divider_210",
					'single_tribe_venue_content_padding_y',
				),
			),
		);
		return $js_data;
	...
	public function add_customizer_fields() {
		$this->defaults = apply_filters( 'grimlock_the_events_calendar_single_tribe_venue_customizer_defaults', array(
			'single_tribe_venue_custom_header_displayed'            => has_header_image(),
			'single_tribe_venue_address_custom_header_displayed'    => false,
			'single_tribe_venue_phone_custom_header_displayed'      => false,
			'single_tribe_venue_website_custom_header_displayed'    => false,
			'single_tribe_venue_breadcrumb_custom_header_displayed' => true,

			'single_tribe_venue_thumbnail_displayed'                => true,
			'single_tribe_venue_address_displayed'                  => true,
			'single_tribe_venue_phone_displayed'                    => true,
			'single_tribe_venue_website_displayed'                  => true,
			'single_tribe_venue_breadcrumb_displayed'               => true,

			'single_tribe_venue_custom_header_layout'               => '12-cols-center',
			'single_tribe_venue_custom_header_container_layout'     => 'classic',
			'single_tribe_venue_layout'                             => '12-cols-left',
			'single_tribe_venue_sidebar_mobile_displayed'           => true,
			'single_tribe_venue_container_layout'                   => 'classic',

			'single_tribe_venue_back_button_displayed'              => true,

			'single_tribe_venue_custom_header_padding_y'            => GRIMLOCK_SECTION_PADDING_Y,
			'single_tribe_venue_content_padding_y'                  => GRIMLOCK_CONTENT_PADDING_Y,
		) );
		...
		$this->add_address_custom_header_displayed_field(    array( 'priority' => 30 ) );
		$this->add_phone_custom_header_displayed_field(      array( 'priority' => 40 ) );
		$this->add_website_custom_header_displayed_field(    array( 'priority' => 50 ) );
		...
		$this->add_address_displayed_field(                  array( 'priority' => 120 ) );
		$this->add_phone_displayed_field(                    array( 'priority' => 130 ) );
		$this->add_website_displayed_field(                  array( 'priority' => 140 ) );
	...
	/**
	 * Add a Kirki checkbox to set the address display in the custom header.
	 *
	 * @since 1.1.5
	 *
	 * @param array $args
	 */
	protected function add_address_custom_header_displayed_field( $args = array() ) {
		if ( class_exists( 'Kirki' ) ) {
			$args = wp_parse_args( $args, array(
				'type'     => 'checkbox',
				'section'  => $this->section,
				'label'    => esc_html__( 'Display address', 'grimlock-the-events-calendar' ),
				'settings' => "{$this->id}_address_custom_header_displayed",
				'default'  => $this->get_default( "{$this->id}_address_custom_header_displayed" ),
				'priority' => 10,
			) );

			Kirki::add_field( 'grimlock', apply_filters( "grimlock_{$this->id}_customizer_address_custom_header_displayed_field_args", $args ) );
		}
	}
	...
	/**
	 * Add a Kirki checkbox to set the address display in the content.
	 *
	 * @since 1.1.5
	 *
	 * @param array $args
	 */
	protected function add_address_displayed_field( $args = array() ) {
		if ( class_exists( 'Kirki' ) ) {
			$args = wp_parse_args( $args, array(
				'type'     => 'checkbox',
				'section'  => $this->section,
				'label'    => esc_html__( 'Display address', 'grimlock-the-events-calendar' ),
				'settings' => "{$this->id}_address_displayed",
				'default'  => $this->get_default( "{$this->id}_address_displayed" ),
				'priority' => 10,
			) );

			Kirki::add_field( 'grimlock', apply_filters( "grimlock_{$this->id}_customizer_address_displayed_field_args", $args ) );
		}
	}
	...
	public function add_custom_header_args( $args ) {
		...
		if ( $this->is_template() ) {
			...
			$args['single_post_back_displayed']           = $this->get_theme_mod( 'single_tribe_venue_breadcrumb_custom_header_displayed' );
			$args['single_tribe_venue_address_displayed'] = $this->get_theme_mod( 'single_tribe_venue_address_custom_header_displayed' );
			$args['single_tribe_venue_phone_displayed']   = $this->get_theme_mod( 'single_tribe_venue_phone_custom_header_displayed' );
			$args['single_tribe_venue_website_displayed'] = $this->get_theme_mod( 'single_tribe_venue_website_custom_header_displayed' );
		}
	...
	public function is_template() {
		$is_template = is_singular( 'tribe_venue' );
		return apply_filters( 'grimlock_the_events_calendar_single_tribe_venue_customizer_is_template', $is_template );
	}
