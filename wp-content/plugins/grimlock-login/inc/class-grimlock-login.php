...
class Grimlock_Login {
	...
	public function __construct() {
		...
		// Remove language switcher from login screen
		add_filter( 'login_display_language_dropdown', '__return_false', 10 );
	}
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'grimlock-login', GRIMLOCK_LOGIN_PLUGIN_DIR_URL . 'assets/js/main.js', array(), GRIMLOCK_LOGIN_VERSION, true );
	...
	public function add_lost_password_register_link( $content, $args ) {
		...
		<div class="login-footer">
			<?php if ( get_option( 'users_can_register' ) && empty( $args['hide_register'] ) ) {
