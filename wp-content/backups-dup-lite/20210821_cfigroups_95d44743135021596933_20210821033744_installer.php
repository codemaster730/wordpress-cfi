...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210821_cfigroups_95d44743135021596933_20210821033744_archive.zip';
	const ARCHIVE_SIZE		 = '317298423';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '95d4474-21033744';
    const SECONDARY_PACKAGE_HASH = 'cf6eaed-21033744';
	const VERSION			 = '1.4.2';
