...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '2022_Azure_Migration_bbd79a9c1ae93f5c4222_20220516165834_archive.zip';
	const ARCHIVE_SIZE		 = '302747727';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'bbd79a9-16165834';
    const SECONDARY_PACKAGE_HASH = '240d83b-16165834';
	const VERSION			 = '1.4.5';
