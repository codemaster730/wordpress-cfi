...
if ( ! class_exists( 'Cera_Grimlock' ) ) :
	...
	class Cera_Grimlock {
		...
		public function __construct() {
			...
			add_filter( 'grimlock_the_events_calendar_tribe_events_section_widget_post_thumbnail_size', array( $this, 'change_query_section_widget_post_thumbnail_size'      ), 10, 2 );
