...
if ( ! function_exists( 'cera_the_sticky_mark' ) ) :
	...
	function cera_the_sticky_mark() {
		if ( is_sticky() ) : ?>
			<span class="badge badge-primary post-sticky"  data-toggle="tooltip" data-placement="top" title="<?php esc_attr_e( 'Sticky', 'cera' ); ?>"><i class="cera-icon cera-pushpin"></i> <span class="badge__name"><?php esc_html_e( 'Sticky', 'cera' ); ?></span></span>
			<?php
		endif;
	}
endif;
