...
if ( ! defined( 'CERA_PROFILE_HEADER_BACKGROUND_COLOR' ) ) {
	define( 'CERA_PROFILE_HEADER_BACKGROUND_COLOR', CERA_GRAY_DARKEST );
}
...
if ( class_exists( 'Kirki' ) ) {
	global $cera_kirki;
	$cera_kirki = require get_template_directory() . '/inc/kirki/class-cera-kirki.php';
}
