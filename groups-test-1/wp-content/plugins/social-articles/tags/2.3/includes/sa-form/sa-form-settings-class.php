...
class SA_Form_Settings {
    ...
    function __construct()
    {
        ...
        //TODO: Ver en el caso de que se desactive el premium y no se entre al admin antes de entrar al front. Puede romper.
        $rf = SA_Helper::get_registered_fields();
        if(is_admin() || count($rf) == 0 || $rf == ''){
            ...
            foreach ($this->selected_fields as $key=>$field_config){
                ...
                if(is_object($original_field)) {
                    ...
                    if(empty($field_config)){
                        $field_config = $original_field_config;
                    }
/*
                    var_dump($original_field_config);
                    echo "<br>";social 
                    var_dump(get_object_vars($field_config));
                    echo "<br>";
                    echo "<br>";*/
