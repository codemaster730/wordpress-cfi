...
add_action('wp_ajax_markArticlesNotification', 'mark_articles_notification' );
function mark_articles_notification(){
    global $bp;
    check_ajax_referer( 'sa_security_ajax', 'security');
    ...
    bp_notifications_mark_notifications_by_item_id( $user_id, $item_id, $component_name, $component_action, $secondary_item_id = false, $is_new = false );
...
function get_articles($offset, $status, $all = false){
    ...
    $articles_query = new WP_Query( apply_filters('sa_list_articles_params', $args ));
                ...
                <div class="article-content">
                    ...
                    <div class="article-footer">
                        <div class="article-categories">
                            <?php
                            echo apply_filters('sa_category_label',__("Archived", "social-articles" ) ).": ";
                            $selected_categories = wp_get_object_terms(get_the_ID(), 'category', array('fields' => 'names'));
