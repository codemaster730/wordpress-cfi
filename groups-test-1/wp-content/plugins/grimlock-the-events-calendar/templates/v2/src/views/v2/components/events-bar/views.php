...
$is_tabs_style         = empty( $disable_event_search ) && 1 >= count( $public_views );
...
<div class="tribe-events-c-events-bar__views">
	...
	<div <?php tribe_classes( $view_selector_classes ); ?> data-js="tribe-events-view-selector">
		...
		>
			<span class="tribe-events-c-view-selector__button-icon tribe-common-svgicon <?php echo sanitize_html_class( "tribe-common-svgicon--{$view_slug}" ); ?>">
