...
class Grimlock_bbPress {
	...
	public function __construct() {
		...
		require_once GRIMLOCK_BBPRESS_PLUGIN_DIR_PATH . 'inc/customizer/class-grimlock-bbpress-archive-customizer.php';
		...
		require_once GRIMLOCK_BBPRESS_PLUGIN_DIR_PATH . 'inc/customizer/class-grimlock-bbpress-typography-customizer.php';
