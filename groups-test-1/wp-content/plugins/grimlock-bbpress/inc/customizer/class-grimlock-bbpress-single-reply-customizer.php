<?php
/**
 * Grimlock_bbPress_Single_Reply_Customizer Class
 *
 * @author  Themosaurus
 * @since   1.0.0
 * @package grimlock
 ...
 */
class Grimlock_bbPress_Single_Reply_Customizer {
...
return new Grimlock_bbPress_Single_Reply_Customizer();
