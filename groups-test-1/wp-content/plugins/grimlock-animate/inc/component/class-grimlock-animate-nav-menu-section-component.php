<?php
/**
 * Grimlock_Animate_Nav_Menu_Section_Component Class
 *
 * @author  Themosaurus
 * @since   1.0.0
 * @package  grimlock
 ...
 */
class Grimlock_Animate_Nav_Menu_Section_Component extends Grimlock_Nav_Menu_Section_Component {
	/**
	 * Setup class.
	 *
	 * @param array $props
	...
	public function __construct( $props = array() ) {
		parent::__construct( wp_parse_args( $props, array(
			'menu_items_reveal_selector'    => '.section__header, .menu-item, .section__footer',
			'menu_items_reveal'             => 'none',
			'menu_items_reveal_duration'    => 750,
			'menu_items_reveal_interval'    => 50,
			'menu_items_reveal_distance'    => '80px',
			'menu_items_reveal_delay'       => 500,
			'menu_items_reveal_rotate_x'    => 0,
			'menu_items_reveal_rotate_y'    => 0,
			'menu_items_reveal_rotate_z'    => 0,
			'menu_items_reveal_opacity'     => 0,
			'menu_items_reveal_scale'       => 1,
			'menu_items_reveal_easing'      => 'cubic-bezier(0.6, 0.2, 0.1, 1)',
			'menu_items_reveal_view_factor' => 0.5,
			'reveal_mobile'                 => true,
			'reveal_reset'                  => false,
		) ) );
	}
	...
	public function get_data_attributes() {
		...
		return array_merge( $data_attributes, $this->get_element_reveal_data_attributes( 'menu_items' ) );
	}
	...
	public function get_class( $class = '' ) {
		...
		$classes[] = $this->get_element_reveal_class( 'menu_items' );
