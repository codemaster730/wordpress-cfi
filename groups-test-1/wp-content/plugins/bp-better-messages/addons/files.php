...
if ( !class_exists( 'BP_Better_Messages_Files' ) ):
    ...
    class BP_Better_Messages_Files
    {
	    ...
	    public function load_scripts(){
            ...
            wp_enqueue_script( 'uppy-js',  BP_Better_Messages()->url . 'assets/js/uppy.min.js', [], BP_Better_Messages()->version );
            ...
            if ( !empty( $attachments ) ) {
                ...
                if ( !empty( $videos ) ) {
                    ...
                    foreach ( $videos as $video ) {
                        ...
                        $processedUrls[ $message_id ][] = '<div class="video"><div class="video-container">' . $videoTag . '</div></div>';
