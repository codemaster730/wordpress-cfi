...
class Grimlock_Back_To_Top_Button_Customizer extends Grimlock_Base_Customizer {
	/**
	 * @var array The array of elements to target the back to top button in theme.
	 * @since 1.0.0
	 */
	protected $elements;
	...
	public function add_customizer_fields() {
		...
		$this->elements = apply_filters( 'grimlock_back_to_top_button_customizer_elements', array(
			'.btn-back-to-top',
	...
	protected function add_color_field( $args = array() ) {
		if ( class_exists( 'Kirki' ) ) {
			$elements = apply_filters( 'grimlock_back_to_top_button_customizer_color_elements', $this->elements );
			$outputs  = apply_filters( 'grimlock_back_to_top_button_customizer_color_outputs', array(
				$this->get_css_var_output( 'back_to_top_button_color' ),
				array(
	...
	protected function add_background_color_field( $args = array() ) {
		if ( class_exists( 'Kirki' ) ) {
			$elements = apply_filters( 'grimlock_back_to_top_button_customizer_background_color_elements', $this->elements );
			$outputs  = apply_filters( 'grimlock_back_to_top_button_customizer_background_color_outputs', array(
				$this->get_css_var_output( 'back_to_top_button_background_color' ),
				array(
					'element'  => implode( ',', $elements ),
	...
	protected function add_border_color_field( $args = array() ) {
		if ( class_exists( 'Kirki' ) ) {
			$elements = apply_filters( 'grimlock_back_to_top_button_customizer_border_color_elements', $this->elements );
			$outputs  = apply_filters( 'grimlock_back_to_top_button_customizer_border_color_outputs', array(
				$this->get_css_var_output( 'back_to_top_button_border_color' ),
				array(
					'element'  => implode( ',', $elements ),
	...
	protected function add_padding_field( $args = array() ) {
		if ( class_exists( 'Kirki' ) ) {
			$elements = apply_filters( 'grimlock_back_to_top_button_customizer_padding_elements', $this->elements );
			$outputs  = apply_filters( 'grimlock_back_to_top_button_customizer_padding_outputs', array(
				$this->get_css_var_output( 'back_to_top_button_padding', 'rem' ),
				array(
					'element'  => implode( ',', $elements ),
					'property' => 'padding',
					'units'    => 'rem',
	...
	protected function add_border_radius_field( $args = array() ) {
		if ( class_exists( 'Kirki' ) ) {
			$elements = apply_filters( 'grimlock_back_to_top_button_customizer_border_radius_elements', $this->elements );
			$outputs  = apply_filters( 'grimlock_back_to_top_button_customizer_border_radius_outputs', array(
				$this->get_css_var_output( 'back_to_top_button_border_radius', 'rem' ),
				array(
					'element'  => implode( ',', $elements ),
	...
	protected function add_border_width_field( $args = array() ) {
		if ( class_exists( 'Kirki' ) ) {
			$elements = apply_filters( 'grimlock_back_to_top_button_customizer_border_width_elements', $this->elements );
			$outputs  = apply_filters( 'grimlock_back_to_top_button_customizer_border_width_outputs', array(
				$this->get_css_var_output( 'back_to_top_button_border_width', 'px' ),
				array(
					'element'  => implode( ',', $elements ),
