...
class Grimlock_Loader_Customizer extends Grimlock_Base_Customizer {
	...
	protected function add_color_field( $args = array() ) {
		if ( class_exists( 'Kirki' ) ) {
			$elements = apply_filters( 'grimlock_loader_customizer_color_elements', array(
				'.grimlock-loader',
			) );

			$outputs = apply_filters( 'grimlock_loader_customizer_color_outputs', array(
				$this->get_css_var_output( 'loader_color' ),
				array(
					'element'  => $elements,
	...
	protected function add_background_color_field( $args = array() ) {
		if ( class_exists( 'Kirki' ) ) {
			$elements = apply_filters( 'grimlock_loader_customizer_background_color_elements', array(
				'.grimlock-loader-wrapper',
			) );

			$outputs = apply_filters( 'grimlock_loader_customizer_background_color_outputs', array(
				$this->get_css_var_output( 'loader_background_color' ),
				array(
					'element'  => $elements,
