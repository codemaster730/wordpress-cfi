	...
	protected function add_text_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'output'    => $outputs,
				'css_vars'  => $this->get_typography_css_vars( 'text_font' ),
	...
	protected function add_heading_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'transport'   => 'postMessage',
				'output'      => $outputs,
				'css_vars'    => $this->get_typography_css_vars( 'heading_font' ),
				'js_vars'     => $this->to_js_vars( $outputs ),
			) );
	...
	protected function add_heading1_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'priority' => 10,
				'output'   => $outputs,
				'css_vars' => $this->get_typography_css_vars( 'heading1_font' ),
			) );
	...
	protected function add_heading2_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'priority' => 10,
				'output'   => $outputs,
				'css_vars' => $this->get_typography_css_vars( 'heading2_font' ),
			) );
	...
	protected function add_heading3_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'priority' => 10,
				'output'   => $outputs,
				'css_vars' => $this->get_typography_css_vars( 'heading3_font' ),
			) );
	...
	protected function add_heading4_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'priority' => 10,
				'output'   => $outputs,
				'css_vars' => $this->get_typography_css_vars( 'heading4_font' ),
			) );
	...
	protected function add_heading5_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'priority' => 10,
				'output'   => $outputs,
				'css_vars' => $this->get_typography_css_vars( 'heading5_font' ),
			) );
	...
	protected function add_heading6_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'priority' => 10,
				'output'   => $outputs,
				'css_vars' => $this->get_typography_css_vars( 'heading6_font' ),
			) );
	...
	protected function add_display_heading_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'transport'   => 'postMessage',
				'output'      => $outputs,
				'css_vars'    => $this->get_typography_css_vars( 'display_heading_font' ),
				'js_vars'     => $this->to_js_vars( $outputs ),
			) );
	...
	protected function add_display_heading1_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'priority'    => 10,
				'output'      => $outputs,
				'css_vars'    => $this->get_typography_css_vars( 'display_heading1_font' ),
			) );
	...
	protected function add_display_heading2_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'priority' => 10,
				'output'   => $outputs,
				'css_vars' => $this->get_typography_css_vars( 'display_heading2_font' ),
			) );
	...
	protected function add_display_heading3_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'priority' => 10,
				'output'   => $outputs,
				'css_vars' => $this->get_typography_css_vars( 'display_heading3_font' ),
			) );
	...
	protected function add_display_heading4_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'priority' => 10,
				'output'   => $outputs,
				'css_vars' => $this->get_typography_css_vars( 'display_heading4_font' ),
			) );
	...
	protected function add_subheading_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'priority'    => 10,
				'output'      => $outputs,
				'css_vars'    => $this->get_typography_css_vars( 'subheading_font' ),
				'js_vars'     => $this->to_js_vars( $outputs ),
			) );
	...
	protected function add_blockquote_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'transport' => 'postMessage',
				'output'    => $outputs,
				'css_vars'  => $this->get_typography_css_vars( 'blockquote_font' ),
				'js_vars'   => $this->to_js_vars( $outputs ),
			) );
