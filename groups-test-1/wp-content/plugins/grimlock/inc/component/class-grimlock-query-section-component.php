...
class Grimlock_Query_Section_Component extends Grimlock_Section_Component {
	...
	public function __construct( $props = array() ) {
		...
		if ( $this->props['posts_layout'] === '4-4-4-cols-overlay-slider' && ( ! wp_script_is( 'swiper' ) || ! wp_script_is( 'grimlock-swiper' ) ) ) {
	...
	public function get_post_class( $class = '' ) {
		...
		if ( $this->props['posts_layout'] === '4-4-4-cols-overlay-slider' ) {
