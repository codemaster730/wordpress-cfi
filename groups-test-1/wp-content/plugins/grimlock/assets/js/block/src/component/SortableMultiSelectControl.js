...
export default class SortableMultiSelectControl extends Component {
    ...
    render() {
        let { isLoading, label, value, options, onChange, inputValue, onInputChange } = this.props;

        return (
            <BaseControl label={ label } className="grimlock-sortable-multi-select-control">
