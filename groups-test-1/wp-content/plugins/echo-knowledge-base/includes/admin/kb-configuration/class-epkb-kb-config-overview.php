...
class EPKB_KB_Config_Overview {
	 ...
	 * @param $kb_config
	 */
	public static function display_overview( $kb_config ) {
	            ...
	            <div class="<?php echo $class_status; ?>">
	                ...
	                <div class="overview-content">											
						<p class="note_type_1">     <?php
							...
							<div class="epkb-overview-row  ">							<?php
				...
				<div class="overview-content">
					<div class="epkb-overview-row  ">						<?php
						...
						self::display_overview_box( array(
							...
							'content'       => '<p>' . __( 'Subscribe to our Newsletter to learn about new features, receive special offers and more.', 'echo-knowledge-base' ) . '</p>',
							'btn_text_1'      => __( 'Subscribe', 'echo-knowledge-base' ),
					...
					<div class="epkb-overview-row  ">     <?php
						...
						self::display_overview_box( array (
							...
							'btn_url_1'       => 'https://www.echoknowledgebase.com/documentation/configure-kb-with-front-end-editor/',
							'show_box_spacer'   => true,
							'box_spacer_loc'    => 'show-box-spacer-top-right'
						) );
						self::display_overview_box( array(
