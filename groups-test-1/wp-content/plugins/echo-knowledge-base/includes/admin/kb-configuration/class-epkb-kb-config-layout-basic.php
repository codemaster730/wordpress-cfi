...
class EPKB_KB_Config_Layout_Basic {
	...
	public static function get_kb_config_style( $kb_page_layout, $kb_config ) {
        ...
        $form->option_group_filter( $kb_config, $feature_specs, array(
            ...
            'inputs' => array(
		            ...
		            '4' => $form->checkbox( $feature_specs['section_hyperlink_on'] + array(
				            'value'             => $kb_config['section_hyperlink_on'],
				            'input_group_class' => 'config-col-12',
				            'label_class'       => 'config-col-5',
				            'input_class'       => 'config-col-2'
			            ) ),
	...
	public static function demo_1_colors() {  // needs to be Public
		...
		return array(
			...
			'article_search_title_font_color'               =>  '#FFFFFF',
			'article_search_background_color'               =>  '#f7941d',
			'article_search_text_input_background_color'    =>  '#FFFFFF',
			'article_search_text_input_border_color'        =>  '#CCCCCC',
			'article_search_btn_background_color'           =>  '#40474f',
			'article_search_btn_border_color'               =>  '#F1F1F1',
	...
	public static function demo_1_set() {
		return array(
			...
			'template_main_page_display_title'    => 'off',
			...
			'search_title_html_tag'                     => 'div',
			'article_search_layout'                             =>  'epkb-search-form-1',
			'article_search_input_border_width'                 =>  1,
			'article_search_box_padding_top'                    =>  20,
			'article_search_box_padding_bottom'                 =>  20,
			'article_search_box_padding_left'                   =>  0,
			'article_search_box_padding_right'                  =>  0,
			'article_search_box_margin_top'                     =>  0,
			'article_search_box_margin_bottom'                  =>  40,
			'article_search_box_input_width'                    =>  50,
			'article_search_box_results_style'                  =>  'off',
			'article_search_title_html_tag'                     => 'div',
