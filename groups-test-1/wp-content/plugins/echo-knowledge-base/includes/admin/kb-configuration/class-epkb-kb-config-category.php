...
class EPKB_KB_Config_Category {
				...
				<ul>
					<li><?php
						...
						if ( EPKB_Config_Menu::is_frontend_editor_hidden( $kb_config ) ) {
							_e( 'The size of all image icons on the front-end is controlled in Features Wizard -> Main Page - Categories.', 'echo-knowledge-base' );
						} else {
							_e( 'The size of all image icons on the front-end is controlled in the frontend Editor', 'echo-knowledge-base' );
						}	?></li>
	...
	/**
	 * Retrieve icon settings for all Categories
	 * @param $kb_id
	 * @return array
	 */
