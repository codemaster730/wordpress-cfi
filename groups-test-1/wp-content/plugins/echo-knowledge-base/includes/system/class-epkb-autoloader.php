	...
	public static function autoload( $class ) {
		...
		if ( $classes === null ) {
			$classes = array(
				...
				'epkb_editor_common_config'         =>  'includes/admin/editor/class-epkb-editor-common-config.php',
				...
				// HELP DIALOG
				'epkb_help_dialog_ctrl'             =>  'includes/features/help-dialog/class-epkb-help-dialog-ctrl.php',
				'epkb_help_dialog_ctrl_faq'         =>  'includes/features/help-dialog/class-epkb-help-dialog-ctrl-faq.php',
				'epkb_help_dialog_ctrl_location'    =>  'includes/features/help-dialog/class-epkb-help-dialog-ctrl-location.php',
				'epkb_help_dialog_search'           =>  'includes/features/help-dialog/class-epkb-help-dialog-search.php',
				'epkb_help_dialog_view'             =>  'includes/features/help-dialog/class-epkb-help-dialog-view.php',
				'epkb_help_dialog_view_faq'         =>  'includes/features/help-dialog/class-epkb-help-dialog-view-faq.php',
				'epkb_help_dialog_view_location'    =>  'includes/features/help-dialog/class-epkb-help-dialog-view-location.php'
			);
		}
