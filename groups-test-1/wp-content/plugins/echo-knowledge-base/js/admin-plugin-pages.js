jQuery(document).ready(function($) {
	...
	if ( $('.epkb-manage-kb-container').length ) {
		...
		$('.epkb-manage-tabs__button__title').on('click',function(){
		...
		// Top panel tabs 
		$('.epkb-manage-content__tab-button').on('click',function(){
			$(this).parent().find('.epkb-manage-content__tab-button').removeClass('active');
			$(this).addClass('active');
			
			$(this).closest('.epkb-manage-content').find('> .epkb-manage-content__tabs > .epkb-manage-content__tab').removeClass('active');
			$( $(this).data('target') ).addClass('active');
		...
		// Delete KB dialog
		$('.epkb-delete-kbs .error-btn').on('click',function(){
			$(this).closest('.epkb-delete-kbs').find( '.epkb-dialog-box-form' ).toggleClass( 'epkb-dialog-box-form--active' );
			return false;
		});
		$('.epkb-delete-kbs .epkb-dbf__footer__accept__btn').on('click',function(){
		...
		// Activate KB dialog
		$('#epkb-activate-kb').find('.epkb-dbf__footer__accept__btn').on('click',function() {
			...
			activate_form.trigger( 'submit' );
		});

		$('.epkb-dbf__close, .epkb-dbf__footer__cancel__btn').on('click',function(){
	...
	$('.epkb-article-structure-dialog').on('click',function(e){
		e.preventDefault();
		$(this).closest('#epkb-config-main-info').find( '.epkb-dialog-box-form' ).toggleClass( 'epkb-dialog-box-form--active' );
		return false;
	});

	$('.epkb-dbf__close, .epkb-dialog-box-form .epkb-dbf__footer__cancel').on('click',function(){
