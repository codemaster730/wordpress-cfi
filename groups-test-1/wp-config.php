...
define( 'DB_NAME', 'humajvue_groups' );

/** MySQL database username */
define( 'DB_USER', 'humajvue_groups' );

/** MySQL database password */
define( 'DB_PASSWORD', '()(p-1lDSwul85' );
...
define('WP_HOME', 'https://groups.cficast.com/groups-test-1'); 
define('WP_SITEURL', 'https://groups.cficast.com/groups-test-1'); 
